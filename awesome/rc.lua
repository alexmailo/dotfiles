...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup({
		...
		wibox.widget({
			wibox.widget.textbox(" " .. capture("paru -Qu | wc -l", false)),
			wibox.widget.textbox(" " .. capture("uname -r", false)),
			awful.widget.watch([[ bash -c "uptime  -p"]], 60, function(widget, stdout)
				widget:set_text(" " .. stdout)
			end),
			-- wibox.widget.textbox("Hello, Alex!" ),
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "x", function()
		awful.spawn("rofi -show drun -theme ~/.config/rofi/launchers/misc/blurry.rasi")
